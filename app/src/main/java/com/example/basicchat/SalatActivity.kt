...
class SalatActivity : RobotActivity(), RobotLifecycleCallbacks {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val but_home = findViewById<ImageButton>(R.id.but_home14)
    ...
    override fun onRobotFocusGained(qiContext: QiContext?) {
        ...
        val say = SayBuilder.with(qiContext)
            .withText("Khitharki Salat also? Gute Wahl! Viel Spaß beim kochen. Solltest du etwas anderes von mir wollen Navigiere über meinen Bildschirm zurück oder über den Homebutton an den Anfang") //Text den Pepper beim start sagt.
            .build()
